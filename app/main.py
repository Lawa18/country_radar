...
APP_VERSION = os.getenv("CR_VERSION", "2025.10.19")
...
async def log_requests(request: Request, call_next):
    ...
    if path in ("/__action_probe", "/__probe_series", "/__compat_probe",
                "/v1/country-lite", "/country-data", "/v1/debt", "/v1/debt-bundle"):
...
# Make sure these files exist; missing ones will be skipped gracefully.
